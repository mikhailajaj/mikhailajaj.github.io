...
export default function BlogLoading() {
  return (
    <div className="pt-10 min-h-screen bg-white dark:bg-gray-900"> {/* Account for fixed navigation */}
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {[1, 2, 3].map((j) => (
                      <div
                        key={j}
                        className="h-6 w-16 bg-gray-300 dark:bg-gray-700 rounded-md animate-pulse"
                      ></div>
                    ))}
                  </div>
