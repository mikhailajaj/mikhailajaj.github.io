...
import EnhancedMagicButton from './ui/EnhancedMagicButton';
    ...
    <div ref={heroRef} className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            <span className="text-primary-700 dark:text-primary-300 font-semibold">Full-Stack</span>
            <span className="text-neutral-500 dark:text-neutral-400 mx-2">|</span>
            <span className="text-accent-700 dark:text-accent-300 font-semibold">Cloud</span>
            <span className="text-neutral-500 dark:text-neutral-400 mx-2">|</span>
            <span className="text-secondary-700 dark:text-secondary-300 font-semibold">Data</span>
          </motion.h2>
          ...
          <motion.div 
            variants={staggerConfig.item}
            className="text-center text-neutral-700 dark:text-neutral-200 mb-10 text-xl md:text-2xl lg:text-3xl max-w-4xl mx-auto"
          >
          ...
          >
            ...
            >
              ...
              <span className="text-xs text-neutral-600 dark:text-neutral-300 font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                Scroll to explore
              </span>
            </motion.div>
          </motion.div>
