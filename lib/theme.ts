...
export const getTextColor = (variant: 'primary' | 'secondary' | 'tertiary' | 'inverse' = 'primary') => ({
  light: theme.text.light[variant],
  dark: theme.text.dark[variant],
});

export const getBackgroundColor = (variant: 'primary' | 'secondary' | 'tertiary' | 'elevated' | 'overlay' = 'primary') => ({
  light: theme.background.light[variant],
  dark: theme.background.dark[variant],
});

export const getBorderColor = (variant: 'primary' | 'secondary' | 'accent' = 'primary') => ({
