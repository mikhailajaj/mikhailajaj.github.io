...
const designMethodologies = [
  ...
  {
    name: 'Service Design',
    description: 'Holistic approach to designing end-to-end service experiences',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Comprehensive UX/UI design expertise spanning user research, visual design, 
            prototyping, and modern design tools and methodologies.
          </p>
        </motion.div>
          ...
          <Card variant="glass">
            <CardContent className="p-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-white">Design Methodologies</h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {designMethodologies.map((methodology, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-white font-medium">{methodology.name}</span>
                      <span className="text-sm text-gray-400 capitalize">{methodology.proficiency}</span>
                    </div>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between mt-1">
                          <span className="text-purple-400 text-xs font-medium">{cert.level}</span>
                  ...
                  {achievements.map((achievement, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <span className="text-purple-400 text-xs font-medium">{achievement.year}</span>
                      </div>
                    </motion.div>
                  ))}
                </div>
