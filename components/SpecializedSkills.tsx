    ...
    >
      ...
      <div className="relative z-10">
        <div className={`flex items-center mb-6`}>
          <div
            className={`p-3 rounded-lg ${accentColor.replace("border-", "bg-").replace("dark:border-", "dark:bg-")}/10`}
          >
            {icon}
          </div>
        ...
        <ul className="space-y-3">
          {skills.map((skill, index) => (
            ...
            >
              <span
                className={`w-2 h-2 rounded-full mr-2 ${accentColor.replace("border-", "bg-").replace("dark:border-", "dark:bg-")}`}
              ></span>
...
const SpecializedSkills = () => {
  return (
    <div className="py-20 px-4" id="skills">
      ...
      >
        With expertise across multiple domains, I bring a versatile skill set to
