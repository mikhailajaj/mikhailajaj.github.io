    ...
    <div className='pb-20 pt-20'>
        ...
        <div>
            ...
            <div className='flex justify-center relative my-20 z-10'>
                ...
                <TextGenerateEffect className='text-center text-[40px] md:text-5xl lg:text-6xl' words='Transforming consept into seamless experience'/>
                <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg  lg:text-2xl'>Hi, I&apos;m Mikhail a Next.js Developer based on Croattia.</p>
                <Link href='#about'>
                    <MagicButton 
                    title='Learn more' 
