...
import { FaCode, FaCloud, FaChartBar, FaPalette, FaSearch, FaArrowRight } from 'react-icons/fa';
...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive technology services including Full-Stack Development, Cloud Architecture, Data Analytics, UX/UI Design, and Technical Consulting.',
  keywords: ['Full-Stack Development', 'Cloud Architecture', 'Data Analytics', 'UX/UI Design', 'Technical Consulting', 'Software Development Services'],
};
...
const services = [
  {
    ...
    description: 'End-to-end web and mobile application development using modern technologies like React, Node.js, and cloud platforms.',
    icon: FaCode,
  ...
  },
  {
    ...
    description: 'Scalable cloud infrastructure design and implementation on AWS, Azure, and Google Cloud Platform.',
    icon: FaCloud,
  ...
  },
  {
    ...
    description: 'Transform your data into actionable insights with advanced analytics, visualization, and machine learning solutions.',
    icon: FaChartBar,
  ...
  },
  {
    ...
    description: 'Strategic technology guidance and code reviews using the BMAD methodology for optimal results.',
    icon: FaSearch,
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
            Comprehensive technology solutions across multiple specializations to drive your business forward
          </p>
          <Link
            href="#services"
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
            Let&apos;s discuss how these services can help achieve your business goals
          </p>
