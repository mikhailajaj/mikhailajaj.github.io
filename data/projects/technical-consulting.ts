...
export const technicalConsultingProjects: Project[] = [
  {
    ...
    description: 'Led comprehensive digital transformation initiative for a Fortune 500 manufacturing company, modernizing legacy systems, implementing cloud infrastructure, and establishing DevOps practices.',
    problem: 'A large manufacturing company was struggling with outdated legacy systems, slow time-to-market, and inability to scale operations. They needed a comprehensive digital transformation strategy.',
    solution: 'Developed and executed a 18-month digital transformation roadmap including cloud migration, microservices architecture, DevOps implementation, and team upskilling. Established agile practices and modern development workflows.',
    impact: {
      metrics: [
      ...
      businessValue: 'Transformed the company\'s technical capabilities, enabling faster innovation, reduced operational costs, and improved market competitiveness.',
      testimonial: {
        quote: 'The transformation strategy was comprehensive and expertly executed. We now have modern, scalable systems that support our growth objectives.',
        author: 'Robert Chen',
        position: 'CTO',
    ...
    tags: ['Digital Transformation', 'Enterprise Architecture', 'Change Management', 'Cloud Migration'],
    images: [
  ...
  },
  {
    ...
    domain: 'technical-consulting',
    description: 'Provided strategic technical guidance and team building support for a fast-growing fintech startup, establishing scalable architecture and development practices.',
    problem: 'A rapidly growing fintech startup needed to scale their technical team and infrastructure to support 10x user growth while maintaining security and compliance standards.',
    solution: 'Developed comprehensive technical strategy including architecture redesign, team structure optimization, hiring roadmap, and implementation of security-first development practices.',
    impact: {
      metrics: [
      ...
      businessValue: 'Enabled successful scaling from 50K to 500K users while maintaining system reliability and achieving SOC 2 compliance.',
      testimonial: {
        quote: 'The strategic guidance was invaluable during our rapid growth phase. We built a world-class technical team and infrastructure.',
  ...
  },
  {
    ...
    domain: 'technical-consulting',
    description: 'Led agile transformation initiative for a large healthcare organization, implementing Scrum practices, improving delivery velocity, and enhancing cross-team collaboration.',
    problem: 'A healthcare organization with 200+ IT professionals was struggling with slow delivery cycles, poor cross-team communication, and inability to respond quickly to changing requirements.',
    solution: 'Implemented comprehensive agile transformation including Scrum training, process redesign, tool implementation, and cultural change management across 15 development teams.',
    impact: {
      metrics: [
      ...
      businessValue: 'Transformed development culture and practices, enabling faster response to healthcare needs and improved patient care systems.',
      testimonial: {
        quote: 'The agile transformation revolutionized how we work. Our teams are more collaborative, productive, and responsive to patient needs.',
    ...
    tags: ['Agile Transformation', 'Healthcare', 'Process Improvement', 'Training'],
    images: [
  ...
  },
  {
    ...
    domain: 'technical-consulting',
    description: 'Conducted comprehensive technical audit for an e-commerce platform experiencing performance issues, providing optimization recommendations and implementation guidance.',
    problem: 'An e-commerce platform was experiencing severe performance degradation, frequent outages, and scalability issues that were impacting customer experience and revenue.',
    solution: 'Performed detailed technical audit covering architecture, code quality, infrastructure, and processes. Developed optimization roadmap and led implementation of critical improvements.',
    impact: {
      metrics: [
      ...
      businessValue: 'Restored system reliability and performance, enabling business growth and preventing significant revenue loss during peak seasons.',
      testimonial: {
        quote: 'The technical audit identified critical issues we hadn\'t seen. The optimization recommendations transformed our platform performance.',
    ...
    tags: ['Technical Audit', 'Performance Optimization', 'E-commerce', 'Infrastructure'],
    images: [
...
export const getTechnicalConsultingTechnologies = () => Object.values(technologies);
...
export const getTechnicalConsultingStats = () => ({
  ...
  domains: ['Digital Transformation', 'Agile Coaching', 'Technical Strategy', 'Team Building']
});