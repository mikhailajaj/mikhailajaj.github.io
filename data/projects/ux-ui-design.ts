...
export const uxuiProjects: Project[] = [
  {
    ...
    domain: 'ux-ui-design',
    description: 'Complete UX/UI redesign of a mobile banking application, focusing on user experience optimization, accessibility, and modern design patterns to increase user engagement and transaction completion rates.',
    problem: 'A regional bank\'s mobile app had poor user engagement, high abandonment rates during transactions, and accessibility issues that prevented many users from completing basic banking tasks.',
    solution: 'Conducted comprehensive user research, created user personas and journey maps, redesigned the entire app with a focus on accessibility and usability. Implemented a design system and conducted extensive usability testing.',
    impact: {
      metrics: [
      ...
      businessValue: 'Increased digital banking adoption by 45% and reduced customer service calls by 30%, saving the bank $2.1M annually in operational costs.',
      testimonial: {
        quote: 'The redesign transformed our mobile banking experience. User satisfaction scores increased dramatically and we saw immediate business impact.',
        author: 'Lisa Chen',
  ...
  },
  {
    ...
    domain: 'ux-ui-design',
    description: 'Designed a comprehensive patient portal and design system for a healthcare network, enabling patients to manage appointments, view medical records, and communicate with providers.',
    problem: 'A healthcare network needed a unified digital experience across multiple touchpoints, but lacked design consistency and had poor patient engagement with existing digital tools.',
    solution: 'Created a comprehensive design system, redesigned the patient portal with focus on health literacy and accessibility, and established design guidelines for all digital touchpoints.',
    impact: {
      metrics: [
      ...
      businessValue: 'Improved patient engagement and reduced administrative overhead, resulting in $1.8M annual cost savings and improved patient outcomes.',
      testimonial: {
        quote: 'The new patient portal has revolutionized how our patients interact with our services. The design system ensures consistency across all our digital properties.',
    ...
    tags: ['Healthcare', 'Design System', 'Accessibility', 'Patient Experience'],
    images: [
  ...
  },
  {
    ...
    domain: 'ux-ui-design',
    description: 'Redesigned the checkout experience for a major e-commerce platform, focusing on conversion optimization, mobile experience, and reducing cart abandonment through UX improvements.',
    problem: 'An e-commerce platform was experiencing 68% cart abandonment rate and poor mobile conversion, losing significant revenue due to checkout friction and usability issues.',
    solution: 'Conducted user testing and analytics review, redesigned the entire checkout flow with progressive disclosure, guest checkout options, and mobile-first approach. Implemented A/B testing for optimization.',
    impact: {
      metrics: [
      ...
      businessValue: 'Conversion rate optimization resulted in $3.2M additional annual revenue and improved customer satisfaction scores.',
      testimonial: {
        quote: 'The checkout redesign had immediate impact on our bottom line. Cart abandonment dropped significantly and mobile sales increased dramatically.',
    ...
    tags: ['E-commerce', 'Conversion Optimization', 'Mobile Design', 'A/B Testing'],
    images: [
  ...
  },
  {
    ...
    domain: 'ux-ui-design',
    description: 'Redesigned a complex analytics dashboard for a SaaS platform, focusing on data visualization, user workflow optimization, and creating an intuitive interface for non-technical users.',
    problem: 'A SaaS analytics platform had a complex, overwhelming interface that prevented users from effectively analyzing their data, leading to low user engagement and high churn rates.',
    solution: 'Conducted user interviews and workflow analysis, redesigned the dashboard with progressive disclosure, improved data visualization, and created customizable views for different user types.',
    impact: {
      metrics: [
      ...
      businessValue: 'Improved user retention and engagement led to 35% increase in subscription renewals and $1.5M additional ARR.',
      testimonial: {
        quote: 'The dashboard redesign made our complex analytics accessible to all our users. We saw immediate improvements in engagement and retention.',
        author: 'David Park',
...
export const getUXUIStats = () => ({
  ...
  domains: ['Mobile Design', 'Web Applications', 'Design Systems', 'User Research']
});