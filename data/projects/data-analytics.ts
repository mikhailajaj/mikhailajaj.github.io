...
export const dataAnalyticsProjects: Project[] = [
  {
    ...
    description:
      "Built a comprehensive customer behavior analytics platform using Python, machine learning, and real-time data processing to predict customer churn and optimize marketing campaigns.",
    problem:
      "An e-commerce company was losing customers at an alarming rate and needed insights into customer behavior patterns to improve retention and optimize marketing spend.",
    solution:
      "Developed a machine learning pipeline using Python, Scikit-learn, and Apache Spark to analyze customer data, predict churn probability, and segment customers for targeted marketing. Implemented real-time dashboards using Plotly and deployed on AWS.",
    impact: {
      metrics: [
      ...
      businessValue:
        "Saved $1.2M annually in customer acquisition costs and increased revenue by $3.5M through improved retention strategies.",
      testimonial: {
        quote:
          "The analytics platform transformed how we understand our customers. The churn prediction model alone saved us millions in retention costs.",
        author: "Sarah Chen",
  ...
  },
  {
    ...
    domain: "data-analytics",
    description:
      "Developed an advanced fraud detection system using deep learning and anomaly detection algorithms to identify suspicious transactions in real-time for a fintech company.",
    problem:
      "A fintech startup was experiencing significant losses due to fraudulent transactions and needed an automated system to detect and prevent fraud in real-time without impacting legitimate users.",
    solution:
      "Built a multi-layered fraud detection system using ensemble machine learning models, deep neural networks, and graph analytics. Implemented real-time scoring using Apache Kafka and deployed on AWS with auto-scaling capabilities.",
    impact: {
      metrics: [
      ...
      businessValue:
        "Reduced fraud losses by 85% while maintaining seamless user experience, saving $2.8M annually and improving customer trust.",
      testimonial: {
        quote:
          "The fraud detection system is incredibly accurate and fast. It has dramatically reduced our losses while keeping our legitimate customers happy.",
  ...
  },
  {
    ...
    domain: "data-analytics",
    description:
      "Created a comprehensive supply chain analytics solution using predictive modeling and optimization algorithms to reduce costs and improve delivery times for a logistics company.",
    problem:
      "A logistics company was struggling with inefficient supply chain operations, leading to high costs, delayed deliveries, and poor inventory management across multiple warehouses.",
    solution:
      "Developed predictive models for demand forecasting, route optimization algorithms, and inventory management systems using Python, OR-Tools, and machine learning. Built interactive dashboards for real-time monitoring and decision support.",
    impact: {
      metrics: [
      ...
      businessValue:
        "Optimized supply chain operations resulting in $5.2M annual cost savings and significantly improved customer satisfaction scores.",
      testimonial: {
        quote:
          "The analytics platform revolutionized our supply chain operations. We now have complete visibility and control over our logistics network.",
  ...
  },
  {
    ...
    domain: "data-analytics",
    description:
      "Developed machine learning models to predict patient outcomes and optimize treatment plans for a healthcare network, improving patient care and reducing costs.",
    problem:
      "A healthcare network needed to improve patient outcomes while reducing costs by predicting which patients were at risk of complications and optimizing treatment protocols.",
    solution:
      "Built predictive models using electronic health records, implemented risk stratification algorithms, and created clinical decision support tools. Used ensemble methods and deep learning for outcome prediction.",
    impact: {
      metrics: [
      ...
      businessValue:
        "Improved patient care quality while reducing healthcare costs, leading to better outcomes for 50,000+ patients annually.",
      testimonial: {
        quote:
          "The predictive models have transformed our approach to patient care. We can now identify at-risk patients early and provide targeted interventions.",
