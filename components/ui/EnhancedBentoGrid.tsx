...
import { scrollAnimations, hoverAnimations, createStaggeredAnimation } from "@/lib/animations";
...
export const EnhancedBentoGridItem = ({
  className,
  title,
  description,
  id,
    ...
    >
      ...
      {id === 3 && (
        <motion.div 
          ...
          variants={createStaggeredAnimation(scrollAnimations.slideInFromRight, 0.1).container}
          initial="hidden"
          animate={isInView ? "visible" : "hidden"}
        >
          {/* Left column */}
      ...
      {id === 5 && (
        <motion.div
          variants={createStaggeredAnimation(scrollAnimations.scaleIn, 0.15).container}
          initial="hidden"
          animate={isInView ? "visible" : "hidden"}
        >
