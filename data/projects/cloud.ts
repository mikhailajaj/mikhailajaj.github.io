...
export const cloudProjects: Project[] = [
  {
    ...
    domain: 'cloud',
    description: 'Built a scalable serverless architecture using AWS Lambda, API Gateway, and DynamoDB for a fintech startup, handling 1M+ transactions daily.',
    problem: 'A fintech startup needed a highly scalable, cost-effective platform to handle payment processing with unpredictable traffic patterns and strict security requirements.',
    solution: 'Designed and implemented a serverless microservices architecture using AWS Lambda functions, API Gateway for routing, DynamoDB for data storage, and SQS for async processing. Implemented Infrastructure as Code using Terraform.',
    impact: {
      metrics: [
    ...
    client: {
      ...
      industry: 'Fintech',
      size: 'startup',
      testimonial: 'Mikhail\'s serverless architecture transformed our business. We went from struggling with server costs to processing millions of transactions seamlessly.',
    ...
    featured: true,
    tags: ['Serverless', 'AWS Lambda', 'Microservices', 'Fintech', 'Cost Optimization'],
  ...
  
  {
    ...
    domain: 'cloud',
    description: 'Migrated a monolithic e-commerce platform to Kubernetes, implementing auto-scaling, service mesh, and comprehensive monitoring for improved reliability.',
    problem: 'An enterprise e-commerce company faced scalability issues with their monolithic application, experiencing frequent downtime during peak traffic and difficulty deploying updates.',
    solution: 'Containerized the application using Docker, implemented Kubernetes orchestration with auto-scaling, set up Istio service mesh for traffic management, and established comprehensive monitoring with Prometheus and Grafana.',
    impact: {
      metrics: [
    ...
    client: {
      ...
      industry: 'E-Commerce',
      size: 'large',
      testimonial: 'The Kubernetes migration was flawless. We now handle Black Friday traffic without breaking a sweat, and deployments that used to take hours now take minutes.',
    ...
    featured: true,
    tags: ['Kubernetes', 'Container Orchestration', 'DevOps', 'Auto-scaling', 'Monitoring'],
  ...
  
  {
    ...
    domain: 'cloud',
    description: 'Implemented comprehensive Infrastructure as Code using Terraform and AWS, automating the provisioning and management of cloud resources for a SaaS platform.',
    problem: 'A growing SaaS company was manually managing cloud infrastructure, leading to inconsistencies, security vulnerabilities, and slow environment provisioning.',
    solution: 'Designed and implemented Infrastructure as Code using Terraform modules, automated environment provisioning with GitHub Actions, established security best practices, and created disaster recovery procedures.',
    impact: {
      metrics: [
    ...
    client: {
      ...
      industry: 'SaaS',
      size: 'medium',
      testimonial: 'Mikhail\'s Infrastructure as Code implementation revolutionized our operations. We can now spin up new environments in minutes instead of days.',
    ...
    featured: false,
    tags: ['Infrastructure as Code', 'Terraform', 'Automation', 'Security', 'DevOps'],
  ...
  
  {
    ...
    domain: 'cloud',
    description: 'Led the migration of a legacy on-premises system to AWS cloud, implementing modern architecture patterns and achieving significant cost and performance improvements.',
    problem: 'A traditional manufacturing company was running expensive on-premises infrastructure with poor scalability, high maintenance costs, and limited disaster recovery capabilities.',
    solution: 'Executed a phased cloud migration strategy, re-architected applications for cloud-native patterns, implemented auto-scaling and load balancing, and established comprehensive backup and disaster recovery procedures.',
    impact: {
      metrics: [
    ...
    client: {
      ...
      size: 'large',
      testimonial: 'The cloud migration exceeded all our expectations. We\'re now more agile, cost-effective, and can serve customers globally with confidence.',
    ...
    featured: false,
    tags: ['Cloud Migration', 'AWS', 'Legacy Modernization', 'Cost Optimization', 'Performance'],
