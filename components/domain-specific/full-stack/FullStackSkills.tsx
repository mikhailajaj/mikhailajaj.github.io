    ...
    skills: [
      {
        name: "React/Next.js",
        level: 95,
        description: "Advanced component architecture, SSR, SSG",
      },
      {
        name: "TypeScript",
        level: 90,
      ...
      },
      {
        name: "Tailwind CSS",
        level: 95,
        description: "Responsive design, custom components",
      },
      {
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "NestJS",
        level: 80,
        description: "Enterprise architecture, decorators, guards",
      },
      {
        name: "API Design",
        level: 95,
        description: "REST, GraphQL, OpenAPI documentation",
      },
      {
        name: "Microservices",
        level: 75,
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Redis",
        level: 80,
        description: "Caching, sessions, pub/sub patterns",
      },
      {
        name: "Database Design",
        level: 90,
        description: "Normalization, performance optimization",
      },
    ],
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        level: 75,
        description: "Vercel, Netlify, AWS basics",
      },
      {
        name: "Monitoring",
        level: 70,
...
const methodologies = [
  ...
  {
    name: "Code Review",
    description: "Peer review, quality assurance, knowledge sharing",
  },
  {
    name: "Performance Optimization",
    description: "Bundle analysis, lazy loading, caching strategies",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Comprehensive full-stack development skills spanning modern frontend
            frameworks, scalable backend architectures, and robust database
            solutions.
          </p>
        </motion.div>
        ...
        >
          <Card variant="glass" className="p-8 text-center">
            ...
            <p className="text-gray-300 text-lg mb-6 max-w-4xl mx-auto">
              With 5+ years of experience, I deliver end-to-end web solutions
              using modern technologies. From React frontends to Node.js
              backends, I build scalable applications that drive business
              growth.
            </p>
