...
const expertiseAreas = [
  { name: 'Digital Transformation', icon: <FaRocket />, description: 'End-to-end modernization strategies' },
  { name: 'Agile Coaching', icon: <FaCogs />, description: 'Scrum, Kanban, and process optimization' },
  { name: 'Technical Strategy', icon: <FaChartLine />, description: 'Architecture and technology roadmaps' },
  { name: 'Team Building', icon: <FaUsers />, description: 'Leadership development and scaling' }
];
...
const methodologies = [
  { name: 'Agile/Scrum', icon: <FaCogs />, description: 'Certified Scrum Master and Product Owner' },
  { name: 'Lean Startup', icon: <FaLightbulb />, description: 'MVP development and validation' },
  { name: 'Design Thinking', icon: <FaUsers />, description: 'Human-centered problem solving' }
];
...
const clientTypes = [
  { type: 'Fortune 500 Enterprises', description: 'Large-scale digital transformation' },
  { type: 'Fast-Growing Startups', description: 'Technical strategy and team scaling' },
  { type: 'Healthcare Organizations', description: 'Compliance-focused agile adoption' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-indigo-400 font-medium">Technical Consulting</span>
            </div>
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              I help organizations transform their technical capabilities through strategic 
              consulting, agile coaching, and hands-on leadership that delivers measurable 
          ...
          >
            ...
            <Card variant="glass" className="p-6">
              <h3 className="text-white font-semibold text-lg mb-4">Consulting Impact</h3>
            ...
            {/* Expertise Areas */}
            <Card variant="glass" className="p-6">
              <h3 className="text-white font-semibold text-lg mb-4">Core Expertise</h3>
            ...
            {/* Methodologies */}
            <Card variant="glass" className="p-6">
              <h3 className="text-white font-semibold text-lg mb-4">Methodologies</h3>
              <div className="space-y-4">
                {methodologies.map((methodology, index) => (
                  ...
                  >
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">{methodology.name}</div>
                      <div className="text-gray-400 text-xs">{methodology.description}</div>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            {/* Client Types */}
            <Card variant="glass" className="p-6">
              <h3 className="text-white font-semibold text-lg mb-4">Client Experience</h3>
              <div className="space-y-3">
                {clientTypes.map((client, index) => (
                  ...
                  >
                    <div>
                      <div className="text-white font-medium text-sm">{client.type}</div>
                      <div className="text-gray-400 text-xs">{client.description}</div>
                    </div>
