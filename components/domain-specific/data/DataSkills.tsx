...
const skillCategories = [
  ...
  },
  {
    ...
    skills: technologies.filter(tech => tech.category === 'bigdata' || tech.category === 'cloud')
  }
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Comprehensive data science and analytics expertise spanning machine learning, 
            statistical analysis, and modern data engineering technologies.
          </p>
        </motion.div>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between mt-1">
                          <span className="text-green-400 text-xs font-medium">{cert.level}</span>
                  ...
                  {achievements.map((achievement, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <span className="text-green-400 text-xs font-medium">{achievement.year}</span>
                      </div>
                    </motion.div>
                  ))}
                </div>
