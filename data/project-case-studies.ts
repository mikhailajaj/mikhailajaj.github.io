...
export const projectCaseStudies: ProjectCaseStudy[] = [
  {
    ...
    overview:
      "A comprehensive mobile and web application that revolutionizes traditional holiday gift exchanges by automating the entire process from participant registration to gift preference matching and event management.",
    ...
    impact: {
      ...
      businessValue:
        "Transformed a traditionally stressful holiday coordination task into an enjoyable, automated experience, saving organizers hours of work while improving participant engagement and satisfaction.",
      testimonial: {
        quote:
          "This app completely transformed our company's holiday party planning. What used to take weeks of coordination now happens seamlessly in minutes.",
...

  {
    ...
    overview:
      "Enterprise-grade serverless infrastructure automation platform built on AWS, designed to streamline deployment processes for web applications while ensuring scalability, security, and cost optimization.",

    challenge:
      "Client's development team was spending 2+ hours per deployment with manual processes, leading to frequent errors, inconsistent environments, and delayed releases. The existing infrastructure lacked proper monitoring, scaling capabilities, and cost optimization.",

    solution:
      "Architected and implemented a comprehensive serverless solution using AWS Lambda, API Gateway, and DynamoDB with Infrastructure as Code (Terraform). The platform includes automated CI/CD pipelines, real-time monitoring, auto-scaling capabilities, and cost optimization algorithms.",
    ...
    impact: {
      ...
      businessValue:
        "Enabled rapid, reliable deployments while significantly reducing operational costs and improving system reliability, allowing the development team to focus on feature development rather than infrastructure management.",
      testimonial: {
        quote:
          "The automation platform transformed our deployment process. We went from dreading releases to deploying multiple times per day with confidence.",
        author: "Michael Chen",
        role: "CTO",
...

  {
    ...
    overview:
      "Comprehensive analytics platform that processes and visualizes customer behavior data in real-time, providing businesses with actionable insights to optimize their marketing strategies and improve customer experience.",

    challenge:
      "E-commerce client was struggling to understand customer behavior patterns across multiple touchpoints. Existing analytics tools provided fragmented data views, making it difficult to identify conversion bottlenecks and optimize the customer journey effectively.",

    solution:
      "Built a full-stack analytics platform with React frontend, Node.js backend, and MongoDB for data storage. Implemented real-time data processing pipelines, interactive visualizations, predictive analytics models, and automated reporting systems.",
    ...
    impact: {
      ...
      businessValue:
        "Empowered data-driven decision making that directly translated to improved business metrics and significant revenue growth through optimized customer experiences and targeted marketing strategies.",
      testimonial: {
        quote:
          "The analytics platform gave us insights we never had before. We can now predict customer behavior and optimize our strategies in real-time.",
...
export const getFeaturedProjects = () =>
  projectCaseStudies.filter((project) => project.featured);

export const getProjectsByCategory = (category: ProjectCategory) =>
  projectCaseStudies.filter((project) => project.categories.includes(category));

export const getProjectBySlug = (slug: string) =>
  projectCaseStudies.find((project) => project.slug === slug);

export const getProjectById = (id: string) =>
  projectCaseStudies.find((project) => project.id === id);
