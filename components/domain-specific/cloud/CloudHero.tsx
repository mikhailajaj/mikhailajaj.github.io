...
const techStack = [
  {
    name: "AWS Services",
    icon: <FaAws />,
    description: "Lambda, EC2, S3, RDS, CloudWatch",
  },
  {
  ...
  },
  {
    ...
    icon: <FaServer />,
    description: "CI/CD, Monitoring, Security",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              I design and implement robust cloud architectures using AWS
              services, container orchestration, and Infrastructure as Code to
              build scalable, secure, and cost-effective solutions that drive
              business growth.
            </p>
          ...
          >
              ...
              <div className="space-y-3">
                {certifications.map((cert, index) => (
                  ...
                  >
                    ...
                    <div className="text-muted-foreground text-xs">{cert.year}</div>
                  </motion.div>
                ))}
              </div>
            </Card>
            ...
            <Card variant="glass" className="p-6">
              ...
              <div className="space-y-3">
                <Link
                  href="/case-studies/serverless-microservices-platform"
                  className="flex items-center justify-between p-3 rounded-lg bg-blue-800/50 hover:bg-blue-700/50 transition-colors group"
                >
                  <span className="text-muted-foreground group-hover:text-white">
                    Serverless Architecture Case Study
                  </span>
                  <FaExternalLinkAlt className="text-muted-foreground group-hover:text-blue-400" />
                </Link>
                <Link
                  href="#services"
                  className="flex items-center justify-between p-3 rounded-lg bg-blue-800/50 hover:bg-blue-700/50 transition-colors group"
                >
                  ...
                  <FaArrowRight className="text-muted-foreground group-hover:text-blue-400" />
                </Link>
              </div>
            </Card>
          </motion.div>
