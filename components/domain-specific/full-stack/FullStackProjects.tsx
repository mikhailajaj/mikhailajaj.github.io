...
import {
  fullStackProjects,
  getFeaturedFullStackProjects,
} from "@/data/projects/full-stack";
import {
  FaExternalLinkAlt,
  FaGithub,
  FaArrowRight,
...
const filterOptions = [
  { value: "all", label: "All Projects", count: fullStackProjects.length },
  {
    value: "featured",
    label: "Featured",
    count: getFeaturedFullStackProjects().length,
  },
  {
    value: "saas",
    label: "SaaS",
    count: fullStackProjects.filter((p) => p.tags.includes("SaaS")).length,
  },
  {
    value: "ecommerce",
    label: "E-Commerce",
    count: fullStackProjects.filter((p) => p.tags.includes("E-Commerce"))
      .length,
  },
  {
    value: "healthcare",
    label: "Healthcare",
    count: fullStackProjects.filter((p) => p.tags.includes("Healthcare"))
      .length,
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            ...
            delivering measurable business impact and exceptional user
            experiences.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {filteredProjects.map((project, index) => (
            ...
            >
              <Card
                variant="interactive"
                className="h-full bg-slate-900/50 border-slate-700 hover:border-slate-600 group"
              >
                {/* Project Image */}
