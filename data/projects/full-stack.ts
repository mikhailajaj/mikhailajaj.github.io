...
export const fullStackProjects: Project[] = [
  {
    ...
    domain: 'full-stack',
    description: 'A comprehensive e-commerce solution built with Next.js, featuring real-time inventory management, payment processing, and advanced analytics dashboard.',
    problem: 'A growing retail company needed a scalable e-commerce platform to replace their legacy system that couldn\'t handle increasing traffic and lacked modern features like real-time inventory tracking.',
    solution: 'Developed a full-stack e-commerce platform using Next.js for the frontend, Node.js/Express for the API, MongoDB for data storage, and integrated Stripe for payments. Implemented real-time features using WebSockets and deployed on Vercel with CDN optimization.',
    impact: {
      metrics: [
    ...
    client: {
      ...
      industry: 'E-Commerce',
      size: 'medium',
      testimonial: 'Mikhail delivered an exceptional e-commerce platform that exceeded our expectations. The performance improvements and new features have significantly boosted our sales.',
    ...
    featured: true,
    tags: ['E-Commerce', 'Real-time', 'Payment Integration', 'Analytics', 'Mobile-First'],
  ...
  
  {
    ...
    domain: 'full-stack',
    description: 'A modern task management application with AI-powered project insights, real-time collaboration, and advanced reporting features.',
    problem: 'Small to medium businesses struggled with project coordination and lacked insights into team productivity and project bottlenecks.',
    solution: 'Built a comprehensive SaaS platform with React frontend, NestJS backend, PostgreSQL database, and integrated OpenAI for intelligent task prioritization and project insights.',
    impact: {
      metrics: [
    ...
    client: {
      ...
      industry: 'SaaS',
      size: 'startup',
      testimonial: 'The AI-powered insights have transformed how our clients manage their projects. Mikhail\'s technical expertise and attention to detail were exceptional.',
    ...
    featured: true,
    tags: ['SaaS', 'AI Integration', 'Real-time Collaboration', 'Analytics', 'Team Productivity'],
  ...
  
  {
    ...
    domain: 'full-stack',
    description: 'A secure healthcare portal for patient management, appointment scheduling, and telemedicine consultations with HIPAA compliance.',
    problem: 'A healthcare clinic needed a digital solution to manage patient records, schedule appointments, and conduct virtual consultations while maintaining strict security and compliance standards.',
    solution: 'Developed a HIPAA-compliant web application using Next.js, Node.js, and PostgreSQL with end-to-end encryption, role-based access control, and integrated video calling capabilities.',
    impact: {
      metrics: [
    ...
    client: {
      ...
      industry: 'Healthcare',
      size: 'medium',
      testimonial: 'Mikhail delivered a secure, compliant solution that has revolutionized our patient management process. The telemedicine features were crucial during the pandemic.',
    ...
    featured: false,
    tags: ['Healthcare', 'HIPAA Compliance', 'Telemedicine', 'Security', 'Patient Management'],
  ...
  
  {
    ...
    domain: 'full-stack',
    description: 'A comprehensive platform for real estate investment analysis, property management, and investor relations with advanced financial modeling.',
    problem: 'Real estate investors lacked a centralized platform to analyze properties, manage investments, and communicate with stakeholders effectively.',
    solution: 'Created a full-stack platform with React frontend, Express.js backend, and MongoDB database, featuring property analysis tools, financial modeling, document management, and investor portals.',
    impact: {
      metrics: [
    ...
    client: {
      ...
      size: 'large',
      testimonial: 'The platform has transformed our investment process. The financial modeling tools and investor portal have significantly improved our efficiency and client relationships.',
    ...
    featured: false,
    tags: ['Real Estate', 'Financial Modeling', 'Investment Analysis', 'Portfolio Management'],
