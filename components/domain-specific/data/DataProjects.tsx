...
import { dataAnalyticsProjects, getFeaturedDataAnalyticsProjects } from '@/data/projects/data-analytics';
import { 
  FaExternalLinkAlt, 
  FaGithub, 
  FaArrowRight,
...
const filterOptions = [
  ...
  { value: 'featured', label: 'Featured', count: getFeaturedDataAnalyticsProjects().length },
  { value: 'ml', label: 'Machine Learning', count: dataAnalyticsProjects.filter(p => p.tags.includes('Machine Learning')).length },
  { value: 'bi', label: 'Business Intelligence', count: dataAnalyticsProjects.filter(p => p.tags.includes('Business Intelligence')).length },
  { value: 'predictive', label: 'Predictive Analytics', count: dataAnalyticsProjects.filter(p => p.tags.includes('Predictive Analytics')).length }
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Real-world data science projects that deliver measurable business impact through 
