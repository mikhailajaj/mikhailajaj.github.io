        ...
        <div className='relative z-10 w-full max-w-7xl mx-auto px-4'>
            <div className='flex flex-col items-center justify-center text-center'>
                ...
                <motion.div 
                    ...
                    className='text-center text-gray-700 dark:text-gray-300 mb-8 text-lg md:text-xl lg:text-2xl max-w-2xl mx-auto'
                >
                    I build <TypewriterEffect words={['responsive web applications', 'cloud infrastructure', 'data pipelines', 'mobile experiences']} className="text-blue-600 dark:text-blue-400 font-medium" />
                </motion.div>
