import { 
  FaReact, FaPython, FaLaptopCode, FaDatabase, FaChartBar, FaRegChartBar, 
  FaRProject, FaPencilRuler, FaUserFriends, FaHtml5, FaCss3Alt, FaJs, FaNodeJs, 
  FaGitAlt, FaCloud, FaServer, FaProjectDiagram, FaCheckSquare, FaRobot, FaMicrochip,
  FaPhone, FaLinkedin, FaGithub, FaTwitter
} from 'react-icons/fa';

import { 
  SiTensorflow, SiAmazonaws, SiMicrosoftazure, SiTableau, SiPowerbi, SiMicrosoftsqlserver, 
  SiApachekafka, SiJupyter, SiFigma, SiTypescript, SiDjango, SiMongodb, SiGraphql, 
  SiVisualstudiocode, SiDocker, SiNextdotjs, SiSwift, SiKotlin, SiDotnet, SiKubernetes, 
  SiTerraform, SiCloudflare, SiCodeclimate, SiSonarqube, SiGit, SiIbmwatson, SiNvidia, 
  SiArduino, SiRaspberrypi 
} from 'react-icons/si';

import { 
  MdComputer, MdQueryStats, MdTouchApp, MdOutlineDesignServices, MdLocationOn 
} from 'react-icons/md';

import { 
  DiCode, DiMysql, DiJava 
} from 'react-icons/di';

import { 
  AiOutlineMobile, AiOutlineMail 
} from 'react-icons/ai';

import { 
  BiAnalyse, BiPalette, BiAccessibility, BiCodeBlock 
} from 'react-icons/bi';
...
export const gridItems = [
  {
    ...
    description: "Dive into the origins and core principles of computer science that have paved the way for modern technology and innovation.",
    image: {
      src: "/G2.png",
  ...
  },
  {
    ...
    description: "Explore how data is transforming decision-making in businesses and discover the powerful tools and techniques used to derive insights from data.",
    image: {
      src: "/G1.png",
    ...
    icons: [
      ...
      SiMicrosoftsqlserver, // Enterprise databases
  ...
  },
  {
    ...
    description: "Discover the impact of design on user experiences and the essential principles of creating intuitive, user-friendly interfaces.",
    image: {
      src: "/G3.png",
  ...
  },
  {
    ...
    description: "Experience the thrill of building applications from scratch, bringing ideas to life through coding in web and software development.",
    image: {
      src: "/G10.png",
  ...
  },
  {
    ...
    description: "Understand the fundamentals of cloud computing, including deployment, management, and scalability on platforms like AWS and Azure.",
    image: {
      src: "/G6.png",
  ...
  },
  {
    ...
    description: "Learn the importance of effective software design patterns that enhance code readability, reusability, and maintainability",
    image: {
      src: "/G5.png",
  ...
  },
  {
    ...
    description: "Embark on a journey through emerging fields like artificial intelligence, machine learning, and the Internet of Things that are shaping the future.",
    image: {
      src: "/G9.png",
